...
3) send prompts to ChatGPT API -> responses ("stay"/"swerve")
4) score responses
...
from send_to_chatgpt import judge_prompts_batch
...
def run_experiment(
    ...
    and re-runs prompts->chatgpt->score. This is useful for reproducibility.
    """
...
if __name__ == "__main__":
    # Example run:
    totals, details = run_experiment(seed=0, model="gpt-5.2")
    print("\nTotals:", totals)
